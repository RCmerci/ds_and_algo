...
*** [9/25] Arrangement Rearrangement
    ...
    23. [X] Move all zeroes to end of array
    24. [X] Move all zeroes to end of array | Set-2 (Using single traversal)
    25. [X] Minimum swaps required to bring all elements less than or equal to k together
    26. [X] Rearrange positive and negative numbers using inbuilt sort function
